  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-div-row">
          <div className="sol-perp-position-down">{t('position-size')}</div>
        ...
        <div className="flex-div-row">
          <div className="sol-perp-position-down">{t('notional-size')}</div>
          <div className="sol-perp-position-down-count">
            {initialLoad ? (
              <DataLoader />
            ) : notionalSize ? (
        ...
        <div className="flex-div-row">
          <div className="sol-perp-position-down">{t('average-entry')}</div>
          <div className="sol-perp-position-down-count">
            {initialLoad ? (
              <DataLoader />
            ) : avgEntryPrice ? (
        ...
        <div className="flex-div-row">
          <div className="sol-perp-position-down">{t('break-even')}</div>
          <div className="sol-perp-position-down-count">
            {initialLoad ? (
              <DataLoader />
            ) : breakEvenPrice ? (
